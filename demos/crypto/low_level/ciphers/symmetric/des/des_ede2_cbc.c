...
int main(void)
{
    ...
    /* Input pointer to OpenSSL's DES-EDE2 CBC method must be a multiple of 8. */
    ...
    /* The output of OpenSSL's DES-EDE2 CBC method is always a multiple 8. */
    ...
    DES_ede2_cbc_encrypt(data_to_encrypt, ciphertext, length, &schedule1, &schedule2, (DES_cblock*)iv, DES_ENCRYPT);
    ...
    DES_ede2_cbc_encrypt(ciphertext, plaintext, length, &schedule1, &schedule2, (DES_cblock*)iv, DES_DECRYPT);
