...
int main(void)
{
    ...
    /* Input pointer to OpenSSL's DES PCBC method must be a multiple of 8. */
    ...
    /* The output of OpenSSL's DES PCBC method is always a multiple 8. */
    ...
    /* Copy the IV data to the IV array. The IV array will be updated by the DES_pcbc_encrypt call.*/
    ...
    DES_pcbc_encrypt(data_to_encrypt, ciphertext, length, &schedule, (DES_cblock*)iv, DES_ENCRYPT);
    ...
    DES_pcbc_encrypt(ciphertext, plaintext, length, &schedule, (DES_cblock*)iv,  DES_DECRYPT);
