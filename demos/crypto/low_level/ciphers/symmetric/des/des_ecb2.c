...
int main(void)
{
    ...
    DES_ecb2_encrypt((DES_cblock*)data_to_encrypt, &encrypted_data, &schedule1, &schedule2, DES_ENCRYPT);
    ...
    DES_ecb2_encrypt(&encrypted_data, &decrypted_data, &schedule1, &schedule2, DES_DECRYPT);
