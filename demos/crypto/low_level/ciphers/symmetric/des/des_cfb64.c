...
int main(void)
{
    ...
    DES_cfb64_encrypt(data, ciphertext, length, &schedule, (DES_cblock*)iv, &num, DES_ENCRYPT);
    ...
    DES_cfb64_encrypt(ciphertext, plaintext, length, &schedule, (DES_cblock*)iv, &num, DES_DECRYPT);
