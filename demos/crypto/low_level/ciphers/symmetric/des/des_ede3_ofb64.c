...
int main(void)
{
    ...
    DES_ede3_ofb64_encrypt(data, ciphertext, length, &schedule1, &schedule2, &schedule3, (DES_cblock*)iv, &num);
    ...
    DES_ede3_ofb64_encrypt(ciphertext, plaintext, length, &schedule1, &schedule2, &schedule3, (DES_cblock*)iv, &num);
