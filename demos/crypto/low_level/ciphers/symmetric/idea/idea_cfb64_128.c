...
int main(void)
{
    ...
    idea_cfb64_encrypt(data_to_encrypt, ciphertext, length, &key_schedule, iv, &num, IDEA_ENCRYPT);
    ...
    /* decrypt the data */
    idea_cfb64_encrypt(ciphertext, plaintext, length, &key_schedule, iv, &num, IDEA_DECRYPT);
